...
public class Animation {
    ...
    public Animation (AbstractGameObject go, TextureRegion[] textures, float speed, boolean looping, int id) {
        this.go = go;
        this.looping = looping;
        this.id = id;
        anim = new com.badlogic.gdx.graphics.g2d.Animation(speed, textures);
    }
