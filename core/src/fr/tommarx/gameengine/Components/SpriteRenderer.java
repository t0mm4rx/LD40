...
public class SpriteRenderer extends Component {
    ...
    public SpriteRenderer (AbstractGameObject go, Texture texture, float offsetX, float offsetY) {
        super(go);
        this.texture = new TextureRegion(texture);
        width = getTexture().getWidth() / 100;
        height = getTexture().getHeight() / 100;
    ...
    public SpriteRenderer (AbstractGameObject go, Texture texture, float offsetX, float offsetY, float width, float height) {
        super(go);
        this.texture = new TextureRegion(texture);
        this.width = width;
        this.height = height;
